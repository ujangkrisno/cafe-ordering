...
<div class="container py-4 text-center">
    ...
    <div class="card card-menu p-5 mx-auto" style="max-width:400px;">
        ...
        <img src="https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=<?= urlencode($menu_url) ?>"
        ...
        <p class="small text-info">
            ...
            Pastikan HP terhubung ke WiFi yang sama, lalu buka:
            <br><strong><?= $menu_url ?></strong>
        </p>
        <a href="https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=<?= urlencode($menu_url) ?>"
